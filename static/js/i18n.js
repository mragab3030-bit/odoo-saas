...
(function () {
  ...
  var translations = {
    en: {
      ...
      inv_stock_all_warehouses:       'All Warehouses',
      inv_stock_all_types:            'All Types',
      inv_stock_all_methods:          'All Methods',
      inv_stock_type_storable:        'Storable',
      inv_stock_type_consumable:      'Consumable',
      inv_stock_type_service:         'Service',
      inv_stock_type_goods_tracked:   'Goods (Tracked)',
      inv_stock_type_goods_untracked: 'Goods (Untracked)',
      inv_stock_costing_standard:     'Standard Price',
      inv_stock_costing_avco:         'AVCO',
      inv_stock_costing_fifo:         'FIFO',
    ...
    ar: {
      ...
      inv_stock_all_warehouses:       'جميع المستودعات',
      inv_stock_all_types:            'جميع الأنواع',
      inv_stock_all_methods:          'جميع الطرق',
      inv_stock_type_storable:        'قابلة للتخزين',
      inv_stock_type_consumable:      'استهلاكية',
      inv_stock_type_service:         'خدمة',
      inv_stock_type_goods_tracked:   'سلع (متعقبة)',
      inv_stock_type_goods_untracked: 'سلع (غير متعقبة)',
      inv_stock_costing_standard:     'التكلفة القياسية',
      inv_stock_costing_avco:         'المتوسط',
      inv_stock_costing_fifo:         'الوارد أولاً',
