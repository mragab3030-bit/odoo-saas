...
(function () {
  ...
  var translations = {
    en: {
      ...
      fs_equity:            'Equity',
      fs_total_current_assets: 'Total Current Assets',
      fs_total_non_current_assets: 'Total Non-Current Assets',
      fs_total_current_liabilities: 'Total Current Liabilities',
      fs_total_non_current_liabilities: 'Total Non-Current Liabilities',
      fs_total_liab_equity: 'TOTAL LIABILITIES & EQUITY',
      fs_revenue:           'Revenue',
      ...
      inv_stock_na:                   'N/A',
      inv_stock_no_reorder_tooltip:   'No reorder rules configured',
      inv_stock_kpi_on_hand:          'Total On Hand Products',
      inv_stock_kpi_on_hand_sub:      'Storable — On Hand',
      inv_stock_kpi_total_value:      'Total Stock Value',
      inv_stock_kpi_total_value_sub:  'Valued at Actual Cost',
      inv_stock_kpi_low:              'Low Stock Items',
      inv_stock_kpi_low_sub:          'Below Reorder Point',
      inv_stock_kpi_out:              'Out of Stock',
      inv_stock_kpi_out_sub:          'Zero or Negative Quantity',
      inv_stock_kpi_over:             'Overstock Items',
      inv_stock_kpi_over_sub:         'Above Maximum Quantity',
      inv_stock_kpi_avg_days:         'Avg Days of Stock',
      inv_stock_kpi_avg_days_sub:     'Average Coverage Days',
      inv_stock_chart_value_by_category: 'Stock Value by Category',
      inv_stock_chart_top10:          'Top 10 Products by Value',
      inv_stock_chart_status:         'Stock Status Distribution',
      inv_stock_chart_aging:          'Stock Aging',
      inv_stock_chart_reorder:        'Stock Level vs Reorder Point',
      inv_stock_chart_costing:        'Stock Value by Costing Method',
      inv_stock_chart_warehouses:     'Warehouse Distribution',
      inv_stock_chart_locations:      'Top Storage Locations',
      inv_stock_reorder_empty:        'Configure reorder rules in Odoo to see this chart',
      inv_stock_products_short:       'products',
      inv_stock_showing:              'Showing',
      inv_stock_entries:              'entries (products and variants)',
    },
    ar: {
      // Sidebar sections
      overview:        'نظرة عامة',
      ...
      fs_total_current_assets: 'إجمالي الأصول المتداولة',
      fs_total_non_current_assets: 'إجمالي الأصول غير المتداولة',
      fs_total_current_liabilities: 'إجمالي الالتزامات المتداولة',
      fs_total_non_current_liabilities: 'إجمالي الالتزامات غير المتداولة',
      fs_total_liab_equity: 'إجمالي الالتزامات وحقوق الملكية',
      ...
      inv_stock_no_reorder_tooltip:   'لم يتم تكوين قواعد إعادة الطلب',
      inv_stock_kpi_on_hand:          'إجمالي المنتجات المتاحة',
      inv_stock_kpi_on_hand_sub:      'قابلة للتخزين — متاحة',
      inv_stock_kpi_total_value:      'إجمالي قيمة المخزون',
      inv_stock_kpi_total_value_sub:  'بسعر التكلفة الفعلي',
      inv_stock_kpi_low:              'مخزون منخفض',
      inv_stock_kpi_low_sub:          'تحت نقطة إعادة الطلب',
      inv_stock_kpi_out:              'نفد المخزون',
      inv_stock_kpi_out_sub:          'كمية صفرية أو سالبة',
      inv_stock_kpi_over:             'مخزون زائد',
      inv_stock_kpi_over_sub:         'أعلى من الحد الأقصى',
      inv_stock_kpi_avg_days:         'متوسط أيام المخزون',
      inv_stock_kpi_avg_days_sub:     'متوسط أيام التغطية',
      inv_stock_chart_value_by_category: 'قيمة المخزون حسب الفئة',
      inv_stock_chart_top10:          'أعلى 10 منتجات حسب القيمة',
      inv_stock_chart_status:         'توزيع حالة المخزون',
      inv_stock_chart_aging:          'تقادم المخزون',
      inv_stock_chart_reorder:        'مستوى المخزون مقابل نقطة إعادة الطلب',
      inv_stock_chart_costing:        'قيمة المخزون حسب طريقة التكلفة',
      inv_stock_chart_warehouses:     'توزيع المستودعات',
      inv_stock_chart_locations:      'أعلى مواقع التخزين',
      inv_stock_reorder_empty:        'قم بإعداد قواعد إعادة الطلب في Odoo لعرض هذا الرسم البياني',
      inv_stock_products_short:       'منتجات',
      inv_stock_showing:              'عرض',
      inv_stock_entries:              'سجل (منتجات ومتغيرات)',
    },
  };
